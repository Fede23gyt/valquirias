 ...
 */
function medispa_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function medispa_sanitize_css( $css ) {
 ...
 */
function medispa_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function medispa_sanitize_email( $email, $setting ) {
 ...
 */
function medispa_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function medispa_sanitize_html( $html ) {
 ...
 */
function medispa_sanitize_image( $image, $setting ) {
 ...
 */
function medispa_sanitize_nohtml( $nohtml ) {
 ...
 */
function medispa_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function medispa_sanitize_number_range( $number, $setting ) {
 ...
 */
function medispa_sanitize_select( $input, $setting ) {
 ...
 */
function medispa_sanitize_url( $url ) {
